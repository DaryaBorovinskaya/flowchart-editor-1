...
export function Paper({
  ...
  const createElementPortal = ({
    ...
    return /*#__PURE__*/createPortal(renderElement(element), containerEl);
  };
  const ElementView = dia.ElementView.extend({
    onRender() {
      let portalEl = typeof portalSelector === 'function' ? portalSelector(this) : portalSelector;
  ...
  const bindEvents = paper => {
    ...
    controller.listenTo(graph, attributeChangeEvents, cell => setElement(cell));
    // Update the portal node reference when the element view is rendered
    controller.listenTo(paper, PORTAL_READY_EVENT, (elementView, portalEl) => setElement(elementView.model, portalEl));
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: paperWrapperElRef,
    style: style
  }, /*#__PURE__*/React.createElement(PaperContext.Provider, {
    value: [paperRef.current, setPaperContext]
  }, elementPortals, children));
}