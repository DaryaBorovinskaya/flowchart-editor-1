...
// node_modules/@joint/core/src/dia/attributes/calc.mjs
var props2 = {
  x: "x",
  y: "y",
  width: "w",
...
function evalCalcExpression(expression, bbox2) {
  ...
  const { x, y, width: width2, height: height2 } = bbox2;
  let value = 0;
  switch (property2) {
    case props2.width: {
      value = width2;
...
var textAttributesNS = {
  ...
  "text-wrap": {
    ...
    set: function(value, refBBox, node, attrs) {
      ...
      } else if (isCalcAttribute(width2)) {
        size.width = Number(evalCalcAttribute(width2, refBBox));
      } else {
        if (value.width === null) {
          size.width = Infinity;
        } else if (width2 <= 0) {
      ...
      } else if (isCalcAttribute(height2)) {
        size.height = Number(evalCalcAttribute(height2, refBBox));
      } else {
...
var Cell = Model.extend({
  ...
  toJSON: function() {
    ...
    const finalAttrs = {};
    forIn(attrs, function(attr2, selector) {
      const defaultAttr = defaultAttrs[selector];
      forIn(attr2, function(value, name) {
...
function resolveForTopSourceSide(source, target, nextInLine) {
  ...
  if (tx < smx0 && ty >= sy0) return Directions3.TOP;
  if (tx > smx1 && ty >= sy0) return Directions3.TOP;
...
function resolveForBottomSourceSide(source, target, nextInLine) {
  ...
  if (tx < smx0 && ty <= sy1) return Directions3.BOTTOM;
  if (tx > smx1 && ty <= sy1) return Directions3.BOTTOM;
...
function resolveForLeftSourceSide(source, target, nextInLine) {
  ...
  if (tx >= sx0 && ty <= smy0) return Directions3.LEFT;
  if (tx >= sx0 && ty >= smy1) return Directions3.LEFT;
...
function resolveForRightSourceSide(source, target, nextInLine) {
  ...
  if (tx <= sx1 && ty <= smy0) return Directions3.RIGHT;
  if (tx <= sx1 && ty >= smy1) return Directions3.RIGHT;
...
function routeBetweenPoints(source, target, opt = {}) {
  ...
  if (sourceSide === "left" && targetSide === "right") {
    ...
    const isPointInsideSource = intersection.rectWithRect(inflatedSourceBBox, targetBBox);
    if (soy < toy) {
...
var ElementView = CellView.extend({
  ...
  getTranslateString: function() {
    var position2 = this.model.attributes.position;
...
// node_modules/@joint/core/src/linkTools/helpers.mjs
...
// node_modules/@joint/core/src/linkTools/Boundary.mjs
...
// node_modules/@joint/core/src/linkTools/Button.mjs
...
// node_modules/@joint/core/src/linkTools/Connect.mjs
...
// node_modules/@joint/core/src/linkTools/HoverConnect.mjs
...
// node_modules/@joint/core/src/elementTools/Control.mjs
